                            ...
                            <div id="product_intro" class="container_12">
                                ...
                                <div id="product_intro_preview">
                                    <div class="slides_container">
                                        <div class="slideItem">
                                            <img typeof="foaf:Image" src="{{url(asset('pic/type/ppp.png'))}}" width="300" height="300" alt="" />
                                        </div>
                        ...
                        <div class="view view-catalog view-id-catalog view-display-id-catalog view-dom-id-f90dfdecded6889b99003be1a4572932">
                            <div class="s_listing s_grid_view clearfix">
                                <div class="s_item grid_3">
                                    <div class="s_thumb">
                                        <a href="{{route('node',['id'=>7])}}">
                                            <img typeof="foaf:Image" src="{{url(asset('pic/type/ppp.png'))}}" width="140" height="140" alt="" />
                                        </a>
                                    </div>
                                    <h3>
                                        <span class="field-content">
                                            <a href="{{route('node',['id'=>7])}}">Platinum Single</a>
                                        </span>
                                    </h3>
                                ...
                                <div class="s_item grid_3">
                                    <div class="s_thumb">
                                        <a href="{{route('node',['id'=>5])}}">
                                            <img typeof="foaf:Image" src="{{url(asset('pic/type/ppp.png'))}}" width="140" height="140" alt="" />
                                        </a>
                                    </div>
                                    <h3>
                                        <span class="field-content">
                                            <a href="{{route('node',['id'=>5])}}">Platinum Double </a>
                                        </span>
                                    </h3>
