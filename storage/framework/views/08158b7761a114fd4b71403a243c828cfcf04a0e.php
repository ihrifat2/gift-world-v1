                            ...
                            <div id="product_intro" class="container_12">
                                ...
                                <div id="product_intro_preview">
                                    <div class="slides_container">
                                        <div class="slideItem">
                                            <img typeof="foaf:Image" src="<?php echo e(url(asset('pic/type/ggg.png'))); ?>" width="300" height="300" alt="" />
                                        </div>
                        ...
                        <div class="view view-catalog view-id-catalog view-display-id-catalog view-dom-id-f90dfdecded6889b99003be1a4572932">
                            <div class="s_listing s_grid_view clearfix">
                                <div class="s_item grid_3">
                                    <div class="s_thumb">
                                        <a href="<?php echo e(route('node',['id'=>2])); ?>">
                                            <img typeof="foaf:Image" src="<?php echo e(url(asset('pic/type/ggg.png'))); ?>" width="140" height="140" alt="" />
                                        </a>
                                    </div>
                                    <h3>
                                        <span class="field-content">
                                            <a href="<?php echo e(route('node',['id'=>2])); ?>">Gold Single</a>
                                        </span>
                                    </h3>
                                ...
                                <div class="s_item grid_3">
                                    <div class="s_thumb">
                                        <a href="<?php echo e(route('node',['id'=>4])); ?>">
                                            <img typeof="foaf:Image" src="<?php echo e(url(asset('pic/type/ggg.png'))); ?>" width="140" height="140" alt="" />
                                        </a>
                                    </div>
                                    <h3>
                                        <span class="field-content">
                                            <a href="<?php echo e(route('node',['id'=>4])); ?>">Gold Double </a>
                                        </span>
                                    </h3>
