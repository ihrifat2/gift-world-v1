                            ...
                            <div id="product_info" class="grid_6 omega">
                                ...
                                <dd>
                                    <div class="field field-name-field-model field-type-text field-label-hidden">
                                        <div class="field-items">
                                            <div class="field-item even">platinum Single</div>
                                        </div>
                                    </div>
                                </dd>
                                <dt>Expire Date</dt>
                                                    ...
                                                    <div class="cpt_product_description ">
                                                        <div>
                                                            <div class="field field-name-body field-type-text-with-summary field-label-hidden">
                                                                <div class="field-items">
                                                                    <div class="field-item even" property="content:encoded"><p>platinum Single<br />platinum Single</p>
                                                                    </div>
                                                                </div>
                                                            </div>
