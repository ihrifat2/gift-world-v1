        ...
        <div id="intro_wrap">
            <div class="container_12">
                <div id="breadcrumbs" class="grid_12">
                    <a href="/">Home</a> > <a href="<?php echo e(route('catalog',['id'=>8])); ?>">Gift Cards</a> > <a href="<?php echo e(route('catalog',['id'=>9])); ?>">Silver Card</a>        </div>
                <h1>Silver Double</h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="product_view">
                        <div id="product" class="grid_12">
                            ...
                            <div id="product_info" class="grid_6 omega">
                                <p class="s_price"><span class="s_currency s_before"></span>1500-2800 TK</p>
                                <dl class="clearfix">
                                <dt>Availability</dt>
                                <dd>
                                ...
                                <dd>
                                    <div class="field field-name-field-model field-type-text field-label-hidden">
                                        <div class="field-items">
                                            <div class="field-item even">Silver Double</div>
                                        </div>
                                    </div>
                                </dd>
                                <dt>Expire Date</dt>
                                                    ...
                                                    <div class="cpt_product_description ">
                                                        <div>
                                                            <div class="field field-name-body field-type-text-with-summary field-label-hidden">
                                                                <div class="field-items">
                                                                    <div class="field-item even" property="content:encoded"><p>Silver Double<br />Silver Double</p>
                                                                    </div>
                                                                </div>
                                                            </div>
