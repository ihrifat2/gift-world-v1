      ...
      <div class="region region-content">
         <div id="block-system-main" class="block block-system">
            <div>
               ...
               <a class="btn btn-primary btn-block" href="<?php echo e(url('/user/reg')); ?>" value="Register Now" style="position:absolute;width:190px;height:30px; right:340px;top:178px;color:white;font-size:15px" >Register Now</a>
            </div>
            <div>
               <a class="btn btn-primary btn-block" href="<?php echo e(url('/')); ?>" style="position:absolute;width:70px;height:30px; right:635px;top:230px;color:white;font-size:13px">Go Back</a>
            </div>
         </div>
      </div>  
   </div>
