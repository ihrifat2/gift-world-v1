                            ...
                            <div id="product_intro" class="container_12">
                                ...
                                <div id="product_intro_preview">
                                    <div class="slides_container">
                                        <div class="slideItem">
                                            <img typeof="foaf:Image" src="../pic/type/sss.png" width="300" height="300" alt="" />
                                        </div>
                        ...
                        <div class="view view-catalog view-id-catalog view-display-id-catalog view-dom-id-f90dfdecded6889b99003be1a4572932">
                            <div class="s_listing s_grid_view clearfix">
                                <div class="s_item grid_3">
                                    <div class="s_thumb">
                                        <a href="<?php echo e(route('node',['id'=>3])); ?>">
                                            <img typeof="foaf:Image" src="../pic/type/sss.png" width="140" height="140" alt="" />
                                        </a>
                                    </div>
                                    <h3>
                                        <span class="field-content">
                                            <a href="<?php echo e(route('node',['id'=>3])); ?>">Silver Single</a>
                                        </span>
                                    </h3>
                                    <p class="s_model">Silver Single</p>
                                    <p class="s_price">1500 TK</p>
                                </div>
                                <div class="s_item grid_3">
                                    <div class="s_thumb">
                                        <a href="<?php echo e(route('node',['id'=>6])); ?>">
                                            <img typeof="foaf:Image" src="../pic/type/sss.png" width="140" height="140" alt="" />
                                        </a>
                                    </div>
                                    <h3>
                                        <span class="field-content">
                                            <a href="<?php echo e(route('node',['id'=>6])); ?>">Silver Double </a>
                                        </span>
                                    </h3>
                                    <p class="s_model">Silver Double</p>
                                    <p class="s_price s_promo_price">
                                    <span class="s_old_price">3000 Tk</span>2800 Tk</p>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div> 
