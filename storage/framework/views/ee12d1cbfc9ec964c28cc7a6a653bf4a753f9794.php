    ...
    <div id="intro_wrap">
        <div class="container_12">
            <div id="breadcrumbs" class="grid_12">
                <a href="/">Home</a> > <a href="<?php echo e(route('catalog',['id'=>8])); ?>">Gift Cards</a> > <a href="<?php echo e(route('catalog',['id'=>10])); ?>">Gold Card</a>        
            </div>
            <h1>Gold Single</h1>
        </div>
    </div>
                    ...
                    <div class="product_view">
                        <div id="product" class="grid_12">
                                        ...
                                        <div class="field-items">
                                            <div class="field-item even">
                                                <a id="product_image_preview" rel="prettyPhoto[gallery]" href="../pic/2.jpg">
                                                    <img typeof="foaf:Image" src="../pic/type/ggg.png" width="340" height="340" alt="" />
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="product_info" class="grid_6 omega">
                                <p class="s_price"><span class="s_currency s_before"></span>2000-3500 TK</p>
                                <dl class="clearfix">
                                <dt>Availability</dt>
                                <dd>
                                ...
                                <dd>
                                    <div class="field field-name-field-model field-type-text field-label-hidden">
                                        <div class="field-items">
                                            <div class="field-item even">Gold Single</div>
                                        </div>
                                    </div>
                                </dd>
                                <dt>Expire Date</dt>
                                <dd>
                                    <div class="field field-name-field-manufacturer field-type-taxonomy-term-reference field-label-hidden">
                                        <div class="field-items">
                                            <div class="field-item even">
                                                <a href="../taxonomy/term/17.html" typeof="skos:Concept" property="rdfs:label skos:prefLabel" datatype="">Within 1 month after Buying</a>
                                            </div>
                                        </div>
                                    </div>
                                </dd>
                                ...
                                <div class="field field-name-field-productref field-type-commerce-product-reference field-label-hidden">
                                    <div class="field-items">
                                        <div class="field-item even">
                                        <?php if(Auth::guest()): ?>
                                            <label for="e-mail">Please login for book this card </label>
                                        <?php else: ?>
                                            <form class="commerce-add-to-cart commerce-cart-add-to-cart-form-3" action="insert2" method="post" id="commerce-cart-add-to-cart-form-3" accept-charset="UTF-8">
                                                <div>
                                                    ...
                                                    <div class="cpt_product_description ">
                                                        <div>
                                                            <div class="field field-name-body field-type-text-with-summary field-label-hidden">
                                                                <div class="field-items">
                                                                    <div class="field-item even" property="content:encoded"><p>Gold Single<br />Gold Single</p>
                                                                    </div>
                                                                </div>
                                                            </div>
